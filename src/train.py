...
def train(cfg: DictConfig) -> Tuple[Dict[str, Any], Dict[str, Any]]:
    ...
    # Create an instance of the cleanup handler
    cleanup_handler = WandbCleanupHandler(cfg)

    # Use with statement to wrap the core logic
    with cleanup_handler:
        ...
        # Instantiate model and data module using dynamic config factory
        log.info(f"Instantiating builder <{cfg.builder._target_}>")
        builder_partial = hydra.utils.instantiate(cfg.builder)

        # Complete instantiation: we manually call it and pass the missing cfg parameter
        ...
        # Register trainer instance to handler as key
